...
echo "docker buildx build --output type=docker --platform=linux/arm64 --no-cache -f build/Dockerfile -t jeffdecola/control-fpga-via-raspi-and-webserver ."
docker buildx build --output type=docker --platform=linux/arm64 --no-cache -f build/Dockerfile -t jeffdecola/control-fpga-via-raspi-and-webserver .
echo " "
