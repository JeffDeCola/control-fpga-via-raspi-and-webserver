#!/bin/sh
# control-fpga-via-raspi-and-webserver unit-tests.sh
...
echo "The goal is to set up a go src/github.com/JeffDeCola/control-fpga-via-raspi-and-webserver directory"
...
echo "cp -R ./control-fpga-via-raspi-and-webserver src/github.com/JeffDeCola/."
